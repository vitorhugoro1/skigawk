...
<!--<![endif]-->
    ...
    <?php do_action( '__before_page_wrapper' );
     ...
     if(is_user_logged_in() && $user_role !== 'administrator'){
      ...
      <div class="bar-top">
        <div>
          Olá, <?php echo $user_name; ?> | <a href="<?php echo get_permalink($pages_ids['perfil']);?>">Perfil</a> | <a href="<?php echo get_permalink($pages_ids['inscricoes']);?>">Inscrições</a> | <a href="<?php echo wp_logout_url("http://" . $server . $endereco);?>">Sair</a>
        </div>
      </div>
