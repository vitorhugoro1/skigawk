...
require get_template_directory() . '/extensions/custom-route-api.php';
require get_template_directory() . '/extensions/custom-functions.php';
require get_template_directory() . '/extensions/custom-post-types.php';
require get_template_directory() . '/extensions/custom-post-meta.php';
require get_template_directory() . '/extensions/custom-admin-editor.php';
require get_template_directory() . '/extensions/custom-action.php';
