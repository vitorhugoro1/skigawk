            ...
            <form action="<?php echo admin_url('admin-post.php'); ?>" method="post" enctype="multipart/form-data" encoding="multipart/form-data">
                ...
                <div class="clear">
                    ...
                    <label for="assoc"><b>Nome da Associação</b><br>
                        <select name="assoc" class="input-xxlarge" id="assoc" required>
                            ...
                            foreach ($assoc as $term) {
                                echo sprintf('<option value="%s">%s</option>', $term->slug, $term->name);
                            }
                            ?>
                    ...
                    <label for="modalidade">
                        ...
                        <ul class="modalidade">
                            <?php
                            $categories = get_terms('categoria', array('fields' => 'all', 'hide_empty' => false));
                            foreach ($categories as $category) {
                            ?>
                                <li>
                                    <input type="checkbox" id="<?php echo $category->slug; ?>" name="modalidade[]" value="<?php echo $category->slug; ?>" />
                                    <?php echo $category->name; ?>
                                    <div id="<?php echo $category->slug; ?>">
                                        <ul id="categoria" class="categoria">

                                            <li><input type="radio" name="data-<?php echo $category->slug; ?>" value="novato">Novato (até 01 ano)</li>

                                            <li><input type="radio" name="data-<?php echo $category->slug; ?>" value="iniciante">Iniciante (até 2 anos)</li>

                                            <li><input type="radio" name="data-<?php echo $category->slug; ?>" value="intermediario">Intermediário (até 3 anos)</li>

                                            <li><input type="radio" name="data-<?php echo $category->slug; ?>" value="avancado">Avançado (acima de 4 anos)</li>
