		...
		if(get_post_type($post_id) == 'campeonatos'){
			?>
				<h2 class="nav-tab-wrapper">
					<a href="<?php echo admin_url($link1); ?>" class="nav-tab <?php echo ($_REQUEST['page'] == 'edit_icamp_cat') ? 'nav-tab-active' : ''; ?>"><?php echo __('Modalidades'); ?></a>
					<a href="<?php echo admin_url($link2); ?>" class="nav-tab <?php echo ($_REQUEST['page'] == 'edit_icamp_pag') ? 'nav-tab-active' : ''; ?>"><?php echo __('Pagamentos'); ?></a>
				</h2>
			<?php
		}
	?>
