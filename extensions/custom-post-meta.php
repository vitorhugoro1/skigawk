...
function evento_local()
{
    ...
    $cmb = new_cmb2_box(array(    'id' => 'local',    'title' => __('Local'),    'object_types' => array('eventos', 'campeonatos'),    'context' => 'normal',    'priority' => 'high',    'show_names' => true  ));

    $cmb->add_field(array(    'name' => 'CEP',    'id' => $prefix.'cep',    'type' => 'text_small'  ));
...
function price()
{
    ...
    $cmb->add_field(array(    'name' => 'Vai ser pago?',
    ...
    $cmb->add_field(array(    'name' => 'Valor da Inscrição',
    ...
    $cmb->add_field(array(    'name' => 'Valor da Inscrição Adicional',
...
function nivel_luta()
{
    ...
    $cmb = new_cmb2_box(array(    'id' => 'nivel_luta',
    ...
    $cmb->add_field(array(    'name' => 'Níveis de Luta',
    ...
    $cmb->add_field(array(    'name' => 'Faixa Etária',
    ...
    <table class="form-table">
        <tbody>
            <tr>
                ...
                <td>
                    <?php
                        echo count($meta).' '.((count($meta) == 1) ? 'usuário' : 'usuários');
                    ?>
                </td>
            </tr>
        </tbody>
